...
describe('filterContacts', () => {
  it('filters contacts by search term', () => {
    const result = filterContacts(mockContacts, 'Amelia', 'all');
  ...
  it('filters contacts by lifecycle stage', () => {
    const result = filterContacts(mockContacts, '', 'customer');
  ...
  it('combines search and stage filters', () => {
    const result = filterContacts(mockContacts, 'Northstar', 'qualified');
